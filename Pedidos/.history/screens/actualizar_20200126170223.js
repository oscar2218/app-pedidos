...
import { Container, Content, Button, Body, CardItem, Item, Input, Label, Text } from "native-base";
      ...
      <Container>
        <ImageBackground source={require('../assets/picks/fondo3.jpg')} style={styles.img}>
          ...
          <Content >
            ...
            <Button rounded style={styles.btn} onPress={this.pickFromGallery}>
              <Text style={styles.tex} >Galeria</Text>
            </Button>

            <Button rounded style={styles.btn2} onPress={this.pickFromCamera}>
...
const styles = StyleSheet.create({
  ...
  image: { width: 250, height: 250, backgroundColor: 'gray', left: 40 },
